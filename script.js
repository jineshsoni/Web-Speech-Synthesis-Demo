...
function speak(text) {
  ...
  // Queue this utterance.
	...
	console.log("msg voiceSelect== "+voiceSelect.value);

	document.getElementById('volumeLab').innerHTML = msg.volume.toFixed(2);
	document.getElementById('rateLab').innerHTML = msg.rate.toFixed(2);
	document.getElementById('pitchLab').innerHTML = msg.pitch.toFixed(2);
}
